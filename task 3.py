...
class Cell:
    ...
    def __add__(self, other):
        return f' Размер большой клетки равен: {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'Клетка стала меньше, теперь ее размер равен: {sub} клеточкам' if sub > 0 else 'Больше нет клетки'
